			...
			<div className="flex flex-col items-center gap-15">
				...
				<div className="w-full flex flex-wrap justify-center items-center gap-6 sm:gap-35 opacity-70">
					<img
						...
						alt="Brand"
						className="h-16 sm:h-20 max-w-30 object-contain"
					/>
					<img
						src="../../src/assets/image/image 20.png"
						alt="Brand"
						className="h-16 sm:h-20 max-w-30 object-contain"
					/>
					<img
						src="../../src/assets/image/image 21.png"
						alt="Brand"
						className="h-16 sm:h-20 max-w-30 object-contain"
					/>
					<img
						src="../../src/assets/image/image 22.png"
						alt="Brand"
						className="h-16 sm:h-20 max-w-30 object-contain"
					/>
					<img
						src="../../src/assets/image/image 25.png"
						alt="Brand"
						className="h-16 sm:h-20 max-w-30 object-contain"
					/>
				</div>
